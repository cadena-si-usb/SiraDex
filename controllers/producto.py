...
def seleccion_actividad():
    ...
    for row in campos_id:
        ...
        html_input = '<div class="form-group">'+\
                        ...
                        '<div class="col-sm-9">'+\
                            '<input class="form-control input-'+posibles_campos[tipo_campo]+'" type="'+posibles_campos[tipo_campo]+'" name="'+nombre_campo_input+'"/>'+\
                        '</div>'+\
                    '</div>' 
        ...
        '''# tipo_campos = ['fecha', 'participante', 'ci', 'comunidad', 'telefono', 'texto','documento', 'cantidad entera', 'cantidad decimal']
                        ...
                        '<label for="'+nombre_camp_input+'" class = "control-label col-sm-3">'+nombre_campo+'</label>'+\
                        '<div class="col-sm-9">'+\
                            '<input class="form-control input-'+tipo_campo+'" type="'+posibles_campos[tipo_campo]+'" name="'+nombre_camp_input+'"/>'+\
                        '</div>'+\
                        '<div class="col-sm-6">'+\
